...
class GameInfo(models.Model):
    ...
    server_name = models.CharField()  # 배틀 서버 지역 이름
...
class BattleRecord(models.Model):
    ...
    killer = models.CharField(max_length=100)  # 처형자 구분
    kill_detail = models.CharField(max_length=100)  # 처형자 닉네임
    killer_character = models.CharField(max_length=100)  # 처형자 캐릭터
    killer_weapon = models.CharField(max_length=100)  # 처형자 무기
    cause_of_death = models.CharField(max_length=100)  # 사망 원인
    place_of_death = models.IntegerField()  # 사망 지역
